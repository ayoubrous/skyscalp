                ...
                <div className="body-wrapper">
                    ...
                    <div className="container-fluid">
                        <div className="d-flex align-items-center gap-1 mx-1 mb-2">
                            <div className="card overflow-hidden col-4" style={{ borderRight: "2px solid blue" }}>
                            ...
                            <div className="card overflow-hidden col-4" style={{ borderRight: "2px solid orange" }}>
                                <div className="card-body p-4">
                        ...
                        <div className="d-flex align-items-center gap-1 mx-1 mb-2">
                            ...
                            <div className="card overflow-hidden col-4" style={{ borderRight: "2px solid orange" }}>
                                <div className="card-body p-4">
                                    <h5 className="card-title mb-9 fw-semibold">PUBLISH FURNITURE</h5>
                                    <div className="row align-items-center">
                                        <div className="d-flex align-items-center justify-content-between">
                                            <h1 className="fw-bolder color-primary" style={{ fontSize: "3rem" }}>
                                                {totalFurniture}
